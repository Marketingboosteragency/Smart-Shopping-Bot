# app.py (versión 25.2 - Favicon Implementado)

# ==============================================================================
# SMART SHOPPING BOT - APLICACIÓN COMPLETA CON FIREBASE
# Versión: 25.2 (Favicon Implemented)
# Novedades:
# - FAVICON: Se ha añadido un favicon a las plantillas para mejorar la identidad visual de la aplicación.
